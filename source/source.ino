/* RFID based Automated identity management system - IoT project sketch
  Using ESP32 development board, MFRC522 reader module
  and SSD1306 128X64 0.96 inch OLED display
...
/* Set credentials. */
const char *ssid = "UcchasPC";
const char *password = "pakhirbasha";
const char* device_token  = "e836658407de2895";
//************************************************************************

int timezone = 5.5 * 3600;   // 5.5 hrs for IST, timezone in seconds
int time_dst = 0;
String getData, Link;
String OldCardID = "";
unsigned long previousMillis1 = 0;
unsigned long previousMillis2 = 0;
String URL = "http://192.168.137.1/nitw-ims/getdata.php"; // Set computer IP or the server domain
...
void setup() {
  ...
  Serial.println("reader card initiated...");
  Serial.println();
